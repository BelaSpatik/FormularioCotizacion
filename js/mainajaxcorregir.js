$(document).ready(function () {
  ...
  function selectProvincias () {
    ...
    //$("#departamentos").select2().next().hide() + $("#localidades").select2().next().hide()
    $.ajax ({
      type: "GET",
    ...
    $("#provincias").select2({
      ...
      setTimeout(function(e) {
        $('.select2-dropdown').slideUp("slow", function() {
          $("#provincias").select2('destroy').select2({
            placeholder: "Seleccione una provincia",
            width: "100%"
          });
        });
  ...
  $("#provincias").on("select2:select  select2:unselecting", function () {
    //$("#departamentos").empty() + $("#localidades").empty() + $("#ubicacionLoc").hide()
    $.ajax ({
      type: "GET",
      ...
      $("#ubicacionDepto").hide()
      $("#ubicacionDepto").css("width", "50%")
      $("#departamentos").select2({
        placeholder: "Seleccione un departamento",
        width: "100%"//"50%",
        //dropdownParent: $("#ubicacionDepto")
      }).on('select2:open', function(e) {
        $('.select2-dropdown').hide();
        setTimeout(function() {
          $('.select2-dropdown').slideDown("slow");
        ...
        setTimeout(function(e) {
          $('.select2-dropdown').slideUp("slow", function() {
            $("#departamentos").select2('destroy').select2({
              placeholder: "Seleccione un departamento",
              width: "100%"
            });
          });
